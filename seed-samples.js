...
async function seed() {
  ...
  var s1 = await D.createSample({
    name: '散热风扇·标准型A', spec: 'DC12V·0.35A·3000RPM·Φ80×45mm', model: 'SF-1225-A', station: '马达组',
    notes: '首批试模样品，待研发贴码确认', created_by: rd.id
  });
  ...
  var s2 = await D.createSample({
    name: '静音风扇·低噪音验证', spec: 'DC12V·0.22A·噪音<28dB·Φ92×38mm', model: 'SF-9225-Q', station: '扇叶组',
    notes: '噪音摸底验证用样品', created_by: rd.id
  });
  ...
  var s3 = await D.createSample({
    name: '长寿命验证风扇', spec: 'DC24V·0.5A·2000RPM·Φ120×38mm', model: 'SF-12025-L', station: '成品组',
  ...
  var s4 = await D.createSample({
    name: '量产验证风扇·标准品', spec: 'DC12V·0.35A·Φ80×45mm', model: 'SF-1225-A', station: '马达组',
  ...
  var s5 = await D.createSample({
    name: '竞品对标风扇·A品牌', spec: 'DC12V·0.38A·3200RPM·Φ92×38mm', model: 'SF-9225-C', station: '成品组',
    notes: '竞品对标分析用样品', created_by: rd.id
  });
  ...
  var s6 = await D.createSample({
    name: '调机验证风扇·量产版', spec: 'DC24V·0.45A·IP55·Φ120×38mm', model: 'SF-12025-P', station: '调机样',
  ...
  var s7 = await D.createSample({
    name: '客户端承认样品', spec: 'DC12V·0.35A·Φ80×45mm', model: 'SF-1225-A', station: '成品组',
  ...
  var s8 = await D.createSample({
    name: '年度稽核留样', spec: 'DC12V·0.35A·Φ80×45mm', model: 'SF-1225-A', station: '马达组',
  ...
  var s13 = await D.createSample({
    name: '外观损坏退回样品', spec: 'DC12V·0.35A·Φ80×45mm', model: 'SF-1225-A', station: '马达组',
  ...
  var s14 = await D.createSample({
    name: '精度偏移退回样品', spec: 'DC12V·0.38A·Φ92×38mm', model: 'SF-9225-C', station: '成品组',
  ...
  var s15 = await D.createSample({
    name: '过期作废样品', spec: 'DC12V·0.22A·噪音<28dB·Φ92×38mm', model: 'SF-9225-Q', station: '扇叶组',
