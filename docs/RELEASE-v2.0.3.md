...
> 提交：`35b255d`（版本号统一）、`2604da5`（帮助补全 + bundle 重建）、`ffb6a71`（本发布说明）、规则文件同步提交
...
| 规则文件同步 | **已实施**（2026-09-11 用户授权）：`AGENTS.md` §3 发布说明清单补 `RELEASE-v2.0.3.md`、§13 增「版本号约定」、§14 更新 `README.md` 容量并登记 `flow-ops.js` 顶层函数超限与迁移哨兵红线；`CLAUDE.md` §6、§11 同步 |
