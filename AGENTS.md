...
│   ├── RELEASE-v2.0.0.md / RELEASE-v2.0.1.md / RELEASE-v2.0.2.md / RELEASE-v2.0.3.md / RELEASE-v2.0.4.md / RELEASE-v2.0.5.md  # 发布说明
...
- **版本号约定（2026-09-11）**：发布号 = `package.json.version` = 5 个子系统 `subsystems/*/manifest.json.version` = 最新 `docs/RELEASE-vX.Y.Z.md`（当前 **2.0.5**）；发版时四处 MUST 同步更新
