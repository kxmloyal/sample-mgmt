...
async function seed(pool) {
  ...
  // ═══ 2. ACCEPTED ═══
  var f2 = await insertFix({ name: 'BGA植球治具', spec: 'BGA-484球·0.8mm间距', model: 'BGA-484', station: '植球站', category: '植球治具', status: 'ACCEPTED', requested_by: me01.id, requested_dept: '生技部', request_note: 'BGA维修返修工具', made_by: rd01.id, made_at: daysAgo(3), made_note: '图纸已确认，排期制作', maintenance_cycle_days: 60, storage_location: '研发中心·治具架A' });
  ...
  await addLog(f4.id, 'MAKE_DONE', 'RD', rd01.id, '研发中心', '制作完成');
  await addLog(f4.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD自检通过');
  ...
  await addLog(f5.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD自检通过');
  ...
  await addLog(f6.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f7.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f8.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f9.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f10.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f11.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f12.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f13.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f14.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
  ...
  await addLog(f15.id, 'VERIFY_RD', 'RD', rd01.id, '研发中心', 'RD验证通过');
